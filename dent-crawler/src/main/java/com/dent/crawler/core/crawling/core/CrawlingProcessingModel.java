...
public class CrawlingProcessingModel extends BaseModel {
    ...
    private static final long serialVersionUID = 8000293881378846201L;

    // ad soyad unvan foto url -> personalInfoDTO
    // bağlantı sayısı -> socialInfoDTO
    // email telefon iletişim bilgileri -> contactInfoDTO
    // about -> perfonalInfoDTO
    // iş deneyim -> experienceDTO
    // eğitim geçmişi -> educationDTO
    // sertifica ->certificationDTO
    // yetenekler -> skillsDTO
    // referans -> referenceDTO
    // ödül başarı -> accomplishmentDTO
    // projects -> projectsDTO
    // ilgili alanlari -> interestsDTO
